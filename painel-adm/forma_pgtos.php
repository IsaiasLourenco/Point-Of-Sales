...
<body>
    <div class="mt-4" style="margin-right:25px">
        ...
        ?>
        <h5 style="text-align: center;" class="txt-secondary">FORMAS DE PAGAMENTOS</h5>
        <a href="index.php?pagina=<?php echo $pagina ?>&funcao=novo" type="button" class="btn btn-sm btn-secondary mt-2 mb-2">Nova Forma</a>
                ...
                <table id="usuarios" class="table table-hover" style="width:100%; font-size: 10px;">
                    <div class="table-responsive">
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    <td class="text-center"><?php echo str_pad($res[$i]['codigo'], 3, '0', STR_PAD_LEFT); ?></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Código" value="<?php echo str_pad(@$codigo, 3, '0', STR_PAD_LEFT) ?>" required="">
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="frm-excluir">
                    <div class="modal-body text-center">
                        ...
                        <p>Deseja realmente excluir o registro <strong><?php echo str_pad($_GET['id'], 3, '0', STR_PAD_LEFT); ?> ?</strong></p>
