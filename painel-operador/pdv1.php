...
<!-- FIM SCRIPT PARA MÁSCARAS -->

<!-- SCRIPT LISTA PRODUTOS | BUSCA DADOS | SETA QUANTIDADE PARA 001 | FOCO NO CÓDIGO | FOTO PADRÃO DO PRODUTO -->
...
<!-- FIM SCRIPT LISTA PRODUTOS | BUSCA DADOS | SETA QUANTIDADE PARA 001 | FOCO NO CÓDIGO | FOTO PADRÃO DO PRODUTO -->
...
<!--FIM AJAX PARA BUSCAR DADOS PARA OS INPUTS -->

<!-- SCRIPT CHAMAR FUNÇÃO BUSCAR DADOS -->
<script type="text/javascript">
  var pag = "<?= $pag ?>";
  ...
  function buscarDados() {
    $.ajax({
      ...
      success: function(result) {
        ...
        // Resetar o código de barras e a quantidade
        document.getElementById('codigo').value = "";
        document.getElementById('quantidade').value = "001";
        isProcessing = false;
      },
...
<!-- FIM SCRIPT CHAMAR FUNÇÃO BUSCAR DADOS -->
...
<!-- CHAMA E CALCULA VALOR RECEBIDO -->
<script type="text/javascript">
  $("#valor_recebido").keyup(function() {
    buscarDados();
  });
</script>
<!-- FIM CHAMA E CALCULA VALOR RECEBIDO -->
...
<!-- FIM CHAMA FECHAR VENDAS -->

<!-- SUBMETE FORMULÁRIO PARA FECHAR VENDAS -->
<script type="text/javascript">
...
<!-- FIM SUBMETE FORMULÁRIO PARA FECHAR VENDAS -->

<!-- FORMATA QUANTIDADE PARA (000) -->
<script type="text/javascript">
...
<!-- FIM FORMATA QUANTIDADE PARA (000) -->

<!-- FORMATO MOEDA PARA DESCONTO EM REAIS OU PORCENTO PARA DESCONTO EM PORCENTAGEM -->
<script type="text/javascript">
...
<!-- FIM FORMATO MOEDA PARA DESCONTO EM REAIS OU PORCENTO PARA DESCONTO EM PORCENTAGEM -->

<!-- FORMATO MOEDA PARA VALOR RECEBIDO -->
<script type="text/javascript">
...
<!-- FIM FORMATO MOEDA PARA VALOR RECEBIDO -->