		...
		<div class="modal-content">
			...
			<form method="POST" id="form-baixar">
				<div class="modal-body">
					...
					<p>Deseja Realmente confirmar o Recebimento da conta <?php echo @$_GET['id'] ?>?</p>
				...
				<div class="modal-footer">
					...
					<button name="btn-baixar" id="btn-excluir" type="submit" class="btn btn-danger">Baixar</button>
